...
return d.a.createElement("li",{tabIndex:"-1",role:"option","aria-disabled":"true","aria-selected":"false",className:g()(k.option,Object(i["a"])({},k[n],n)),onClick:o},d.a.createElement("span",{className:k.label},e))}},{key:"renderIcon",value:function(e){if("undefined"!==typeof e&&null!==e){var t=e
return d.a.createElement("span",{className:k.icon},d.a.createElement(t,null))}}},{key:"renderOptions",value:function(){var e=this
...
return d.a.createElement("li",Object.assign({},y,{role:"option",key:p,id:"".concat(o,"_").concat(p),className:g()(k.option,(a={},Object(i["a"])(a,k.selected,m),Object(i["a"])(a,k[c],c),Object(i["a"])(a,k.highlighted,n===u),Object(i["a"])(a,k.disabled,v),Object(i["a"])(a,k.groupLabel,h),Object(i["a"])(a,k.groupItem,b),a)),tabIndex:"-1","aria-selected":m?"true":"false","aria-disabled":v?"true":null}),d.a.createElement("span",{className:k.label},f&&e.renderIcon(f),r))}))}},{key:"render",value:function(){var e=this
...
return d.a.createElement(v["a"],{style:l.style,className:k.container,maxWidth:r||0,borderWidth:"small",borderRadius:"medium",shadow:"resting",background:"primary"},!!this.props.expanded&&d.a.createElement("ul",{className:k.optionsList,id:n,onKeyDown:this.props.onKeyDown,onKeyUp:this.props.onKeyUp,onBlur:this.props.onBlur,onClick:function(e){e.stopPropagation()
...
var x,_,w,C,S,j,k,E,K,T,I,z,P,R
...
var M=(x=Object(m["a"])(),x(_=(C=w=function(e){Object(s["a"])(t,e)
function t(){Object(a["a"])(this,t)
return Object(r["a"])(this,Object(l["a"])(t).apply(this,arguments))}return t}(g["a"]),w.displayName="PositionTarget",w.locatorAttribute="data-position-target",C))||_)
var B=(S=Object(m["a"])(),S(j=(E=k=function(e){Object(s["a"])(t,e)
function t(){Object(a["a"])(this,t)
return Object(r["a"])(this,Object(l["a"])(t).apply(this,arguments))}return t}(g["a"]),k.displayName="PositionContent",k.propTypes={children:p.a.node,placement:v["a"].placement},k.locatorAttribute="data-position-content",E))||j)
var F=(K=Object(b["a"])("7.0.0",null,"Use @instructure/ui-position instead"),T=Object(m["a"])(),I=Object(f["themeable"])(O,D),K(z=T(z=I(z=(R=P=function(e){Object(s["a"])(t,e)
function t(){Object(a["a"])(this,t)
...
var x=g["a"].pick(t.Content,n)
return u.a.createElement(y["a"],Object.assign({},v,{target:d,renderTarget:O,id:i,shouldTrackPosition:a,placement:r,offsetX:l,offsetY:s,mountNode:c,insertAt:p,constrain:m,shouldPositionOverTarget:f,onPositioned:h,onPositionChanged:b}),x)}}])
...
var C=n("Mwhx")
var S,j,k,E
var K=d.a.shape({label:d.a.string.isRequired,value:d.a.string.isRequired,id:d.a.oneOfType([d.a.string,d.a.number]),children:d.a.node})
var T=(S=Object(O["a"])(),S(j=(E=k=function(e){Object(l["a"])(t,e)
function t(e){var n
Object(o["a"])(this,t)
...
n.props.inputRef.apply(Object(x["a"])(n),[e].concat(o))}
...
var L=n("n12J")
var W=n("o4+2")
function N(e){var t=e.borders,n=e.colors,o=e.forms,i=e.spacing,a=e.typography
...
var h=(e={},Object(D["a"])(e,U.tagRoot,true),Object(D["a"])(e,U[f],true),Object(D["a"])(e,U[l],l),Object(D["a"])(e,U.dismissible,i),Object(D["a"])(e,U.button,d),Object(D["a"])(e,U.disabled,a),e)
var g=L["a"].omitViewProps(Object(y["a"])(this.props,t.propTypes),t)
return c.a.createElement(L["a"],Object.assign({},g,{ref:this.handleRef,elementRef:this.props.elementRef,className:B()(o,h),as:d?"button":"span",margin:p,type:d?"button":null,onClick:d?this.handleClick:null,disabled:a||r,display:null,title:u||("string"===typeof s?s:null)}),c.a.createElement("span",{className:U.text},s),d&&i?c.a.createElement(F["a"],{className:U.icon}):null)}},{key:"focused",get:function(){return Object(_["a"])(this._container)}}])
t.displayName="Tag"
return t}(s["Component"]),H.propTypes={className:d.a.string,text:d.a.oneOfType([d.a.string,d.a.node]).isRequired,title:d.a.string,disabled:d.a.bool,readOnly:d.a.bool,dismissible:d.a.bool,margin:P["ThemeablePropTypes"].spacing,onClick:d.a.func,elementRef:d.a.func,size:d.a.oneOf(["small","medium","large"]),variant:d.a.oneOf(["default","inline"])},H.defaultProps={size:"medium",dismissible:false,variant:"default",elementRef:void 0,className:void 0,title:void 0,disabled:false,readOnly:false,margin:void 0,onClick:void 0},X))||q)||q)
function Y(e){var t=e.spacing
return{tagTopMargin:t.xxxSmall,tagStartMargin:t.xxSmall}}Y.canvas=function(e){return{}}
var $,V,G,Q,ee
...
var oe=($=Object(O["a"])(),V=Object(P["themeable"])(Y,te),$(G=V(G=(ee=Q=function(e){Object(l["a"])(t,e)
function t(e){var n
Object(o["a"])(this,t)
n=Object(a["a"])(this,Object(r["a"])(t).call(this,e))
n._input=null
...
n.amendMatchesToState=function(e,t,o,i){if(o&&o.length>0){var a=[].concat(Object(z["a"])(e.selectedOption),Object(z["a"])(o))
...
n.handleKeyDown=function(e){var t=n.state,o=t.filterText,i=t.selectedOption,a=t.selectedOption.length;("Backspace"===e.key||"Delete"===e.key)&&a>0&&""===o&&Object(_["a"])(n._input)&&n.dismiss(e,i[a-1])
n.props.onKeyDown(e)}
n.handleSelect=function(e,t){n.cleanInput()
var o=[].concat(Object(z["a"])(n.state.selectedOption),[t])
...
var o=n[t]
if("object"===typeof e)return Object(I["a"])({},e,{},o)
...
return c.a.createElement(J,Object.assign({className:te.tag,key:Object(C["a"])(t)+t.label,title:t.label,text:e.props.formatSelectedOption(t,n),size:e.props.size,disabled:e.props.disabled,readOnly:e.props.readOnly},i))}))}},{key:"renderInputs",value:function(){var e=this
...
f()(this.state.options,t)||this.setState({options:t})}},{key:"render",value:function(){var e=this.props.multiple?oe:T
...
n._defaultId=Object(E["a"])("Select")
n._optionsId=Object(E["a"])("Select-Options")
n._assistId=Object(E["a"])("Select-assistiveText")
return n}Object(r["a"])(t,[{key:"getSelectedIndex",value:function(e){if(e.selectedOption){var t=e.options.findIndex((function(t){return Object(R["a"])(t)===Object(R["a"])(e.selectedOption)}))
...
return d.a.createElement("span",{className:N.inputIcon},d.a.createElement(e,null))}}},{key:"render",value:function(){var e,n
var a=this.props,r=a.size,l=a.disabled,s=a.readOnly,c=a.editable,u=a.required,p=a.width,f=a.options,h=a.selectedOption,b=a.loadingText,m=a.emptyOption,w=a.visibleOptionsCount,C=a.children,S=a.onStaticClick,j=a.assistiveText,E=a.layout,K=a.announcement,T=a.constrain
var R=Object(I["a"])(this.props,t.propTypes,["allowEmpty","assistiveText","value"].concat(Object(i["a"])(Object.keys(x["FormField"].propTypes))))
var D=f[this.state.highlightedIndex]
D&&this.expanded?R["aria-activedescendant"]="".concat(this._optionsId,"_").concat(D.id):R["aria-activedescendant"]=null
var M=d.a.createElement("label",{htmlFor:this.id,className:N.label},this.props.label)
Object(y["a"])(this.props.label)||(M=d.a.createElement(O["a"],null,M))
return d.a.createElement(x["FormFieldLayout"],Object.assign({},Object(I["c"])(this.props,x["FormFieldLayout"].propTypes),{as:"span",label:M,id:this.id,vAlign:"inline"===E?"middle":null,onMouseDown:this.handleMouseDown}),d.a.createElement("span",{style:{width:p||"auto"},className:g()(N.inputWidth,(e={},Object(o["a"])(e,N.invalid,this.invalid),Object(o["a"])(e,N.focus,this.state.focus),e))},d.a.createElement("span",{ref:this.handleInputContainerRef,className:g()(N.inputContainer,(n={},Object(o["a"])(n,N.invalid,this.invalid),Object(o["a"])(n,N.disabled,l),Object(o["a"])(n,N[r],r),Object(o["a"])(n,N.focus,this.state.focus),n))},C,d.a.createElement("span",{className:N.inputLayout,onClick:this.handleClick},h&&this.renderIcon(),d.a.createElement("input",Object.assign({},R,{id:this.id,className:g()(N.input,Object(o["a"])({},N.editable,c)),onFocus:this.handleFocus,onChange:c?this.handleChange:null,onKeyDown:this.handleKeyDown,onKeyUp:this.handleKeyUp,onBlur:this.handleBlur,type:"text",ref:Object(k["a"])(this.props.inputRef,this.handleInputRef),role:"combobox","aria-expanded":this.expanded,"aria-owns":this.expanded?this._optionsId:null,"aria-describedby":this._assistId,"aria-controls":this.expanded?this._optionsId:null,"aria-autocomplete":c?"list":null,"aria-haspopup":"true",autoComplete:c?"off":null,required:u,"aria-required":u,"aria-invalid":this.invalid?"true":null,readOnly:!c,disabled:l||s})),d.a.createElement(z["a"],{width:"0.875rem",height:"0.875rem",className:N.icon})))),d.a.createElement(v["a"],{open:this.state.expanded},d.a.createElement(_["a"],{trackPosition:this.expanded,placement:this.placement,onPositioned:this.handlePositioned,target:this._inputContainer,constrain:T},d.a.createElement(_["a"].Content,null,d.a.createElement(P["a"],{options:f,selectedOption:h,optionsId:this._optionsId,menuRef:this.handleMenuRef,visibleOptionsCount:w,loadingText:b,emptyOption:m,onStaticClick:S,onHighlightOption:this.highlightOption,onSelect:this.select,expanded:this.state.expanded,onKeyDown:this.handleKeyDown,onKeyUp:this.handleKeyUp,onBlur:this.handleBlur,highlightedIndex:this.state.highlightedIndex,maxWidth:this.props.optionsMaxWidth})))),d.a.createElement("span",{id:this._assistId,style:{display:"none"}},j),d.a.createElement(O["a"],null,d.a.createElement("span",{role:"log","aria-live":"polite","aria-atomic":"true"},K)))}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"expanded",get:function(){return this.state.positioned&&this.state.expanded}},{key:"placement",get:function(){return this.state.expanded?this.props.placement||"bottom stretch":"offscreen"}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"selectedIndex",get:function(){return this.getSelectedIndex(this.props)}}])
t.displayName="SelectField"
return t}(u["Component"]),L.propTypes={selectedOption:f.a.oneOfType([f.a.string,f.a.shape({label:f.a.string.isRequired,value:f.a.string.isRequired,id:f.a.oneOfType([f.a.string,f.a.number]),children:f.a.node,disabled:f.a.bool,icon:f.a.func,groupLabel:f.a.bool})]),options:f.a.arrayOf(f.a.shape({label:f.a.string.isRequired,value:f.a.string.isRequired,id:f.a.oneOfType([f.a.string,f.a.number]),children:f.a.node,disabled:f.a.bool,icon:f.a.func,groupLabel:f.a.bool})),placement:w["a"].placement,label:f.a.node.isRequired,messages:f.a.arrayOf(x["FormPropTypes"].message),size:f.a.oneOf(["small","medium","large"]),layout:f.a.oneOf(["stacked","inline"]),optionsMaxWidth:f.a.string,loadingText:f.a.string,editable:f.a.bool,emptyOption:f.a.node,visibleOptionsCount:f.a.oneOfType([f.a.string,f.a.number]),assistiveText:f.a.string,announcement:f.a.string,onPositioned:f.a.func,onSelect:f.a.func,onStaticClick:f.a.func,onHighlight:f.a.func,width:f.a.string,inline:f.a.bool,children:f.a.node,onFocus:f.a.func,onBlur:f.a.func,onKeyDown:f.a.func,onKeyUp:f.a.func,onClick:f.a.func,onInputChange:f.a.func,onOpen:f.a.func,onClose:f.a.func,id:f.a.string,inputRef:f.a.func,closeOnSelect:f.a.bool,constrain:w["a"].constrain,disabled:f.a.bool,readOnly:f.a.bool,required:f.a.bool},L.defaultProps={emptyOption:"---",selectedOption:null,size:"medium",loadingText:null,announcement:null,options:[],visibleOptionsCount:8,closeOnSelect:true,editable:false,inline:false,constrain:"window",onPositioned:function(){},onSelect:function(e,t){},onStaticClick:function(e){},onHighlight:function(e){},onClick:function(e){},onInputChange:function(e){},onFocus:function(e){},onBlur:function(e){},onKeyDown:function(e){},onKeyUp:function(e){},onOpen:function(e){},onClose:function(e){},disabled:false,readOnly:false,required:false,inputRef:void 0,id:void 0,children:null,width:void 0,assistiveText:void 0,optionsMaxWidth:void 0,layout:void 0,messages:void 0,placement:void 0},W))||F)||F)},sYn3:function(e,t,n){"use strict"
var o
...
//# sourceMappingURL=18-c-edbff50369.js.map