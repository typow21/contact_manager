(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[30],{"97gy":function(e,n,r){"use strict"
...
var l=r.n(d)
var u=r("hPGw")
var v=l.a.createElement("path",{d:"M1743.858 267.012L710.747 1300.124 176.005 765.382 0 941.387l710.747 710.871 1209.24-1209.116z",fillRule:"evenodd",stroke:"none",strokeWidth:"1"})
var h=function(e){Object(s["a"])(n,e)
function n(){Object(o["a"])(this,n)
return Object(i["a"])(this,Object(c["a"])(n).apply(this,arguments))}Object(a["a"])(n,[{key:"render",value:function(){return l.a.createElement(u["a"],Object.assign({},this.props,{name:"IconCheckMark",viewBox:"0 0 1920 1920"}),v)}}])
n.displayName="IconCheckMarkSolid"
return n}(d["Component"])
h.glyphName="check-mark"
h.variant="Solid"
h.propTypes=Object(t["a"])({},u["a"].propTypes)},HVsT:function(e,n,r){"use strict"
r.d(n,"a",(function(){return h}))
var t=r("VTBJ")
var o=r("1OyB")
var a=r("vuIU")
...
h.glyphName="no"
h.variant="Solid"
h.propTypes=Object(t["a"])({},u["a"].propTypes)},J3yE:function(e,n,r){"use strict"
r.d(n,"a",(function(){return h}))
var t=r("VTBJ")
var o=r("1OyB")
var a=r("vuIU")
...
h.variant="Solid"
h.propTypes=Object(t["a"])({},u["a"].propTypes)},"L+/K":function(e,n,r){"use strict"
var t=r("1OyB")
var o=r("vuIU")
var a=r("md7G")
var i=r("foSv")
...
var x=r("J2CL")
var L=r("BTe1")
function R(e){var n=e.colors,r=e.borders,t=e.spacing,o=e.typography,a=e.shadows
return{background:n.backgroundLightest,color:n.textDarkest,marginTop:t.small,borderRadius:r.radiusMedium,borderWidth:r.widthMedium,borderStyle:r.style,contentPadding:"".concat(t.small," ").concat(t.medium),contentFontSize:o.fontSizeMedium,contentFontFamily:o.fontFamily,contentFontWeight:o.fontWeightNormal,contentLineHeight:o.lineHeightCondensed,closeButtonMarginTop:t.xSmall,closeButtonMarginRight:t.xxSmall,iconColor:n.textLightest,iconBackground:n.backgroundLightest,successBorderColor:n.borderSuccess,successIconBackground:n.backgroundSuccess,infoBorderColor:n.borderInfo,infoIconBackground:n.backgroundInfo,warningBorderColor:n.borderWarning,warningIconBackground:n.backgroundWarning,dangerBorderColor:n.borderDanger,dangerIconBackground:n.backgroundDanger,boxShadow:a.depth2}}R.canvas=function(e){return{color:e["ic-brand-font-color-dark"]}}
r.d(n,"a",(function(){return U}))
var E,w,T,A,z
...
var U=(E=Object(f["a"])("7.0.0",{closeButtonLabel:"renderCloseButtonLabel"}),w=Object(x["themeable"])(R,N),E(T=w(T=(z=A=function(e){Object(c["a"])(n,e)
function n(e){var r
Object(t["a"])(this,n)
r=Object(a["a"])(this,Object(i["a"])(n).call(this,e))
r._timeouts=[]
...
r.handleKeyUp=function(e){(r.props.renderCloseButtonLabel||r.props.closeButtonLabel)&&e.keyCode===b.a.codes.esc&&r.close()}
r.state={open:true}
return r}Object(o["a"])(n,[{key:"variantUI",value:function(){return{error:{Icon:B["a"],classNames:m()(N.alert,N.error)},info:{Icon:j["a"],classNames:m()(N.alert,N.info)},success:{Icon:C["a"],classNames:m()(N.alert,N.success)},warning:{Icon:I["a"],classNames:m()(N.alert,N.warning)}}[this.props.variant]}},{key:"clearTimeouts",value:function(){this._timeouts.forEach((function(e){return clearTimeout(e)}))
...
e.setAttribute("aria-atomic",this.props.isLiveRegionAtomic)}}},{key:"createScreenreaderContentNode",value:function(){return d.a.createElement(O["a"],null,this.props.children)}},{key:"createScreenreaderAlert",value:function(){var e=this.getLiveRegion()
if(e){this.srid=Object(L["a"])("Alert")
...
return d.a.createElement("div",{className:N.icon},d.a.createElement(n,{className:N.alertIcon}))}},{key:"renderCloseButton",value:function(){var e=this.props.renderCloseButtonLabel&&Object(y["a"])(this.props.renderCloseButtonLabel)||this.props.closeButtonLabel
return e?d.a.createElement("div",{className:N.closeButton,key:"closeButton"},d.a.createElement(k["a"],{onClick:this.close,size:"small",screenReaderLabel:e})):null}},{key:"renderAlert",value:function(){var e=this.variantUI(),n=e.classNames
return d.a.createElement(_["a"],{as:"div",margin:this.props.margin,className:n,onKeyUp:this.handleKeyUp},this.renderIcon(),d.a.createElement("div",{className:N.content},this.props.children),this.renderCloseButton())}},{key:"render",value:function(){if(this.props.screenReaderOnly){this.getLiveRegion()
...
n.displayName="Alert"
return n}(s["Component"]),A.propTypes={children:h.a.node,variant:h.a.oneOf(["info","success","warning","error"]),margin:x["ThemeablePropTypes"].spacing,liveRegion:h.a.func,liveRegionPoliteness:h.a.oneOf(["polite","assertive"]),isLiveRegionAtomic:h.a.bool,screenReaderOnly:h.a.bool,timeout:h.a.number,renderCloseButtonLabel:h.a.oneOfType([h.a.func,h.a.node]),closeButtonLabel:h.a.string,onDismiss:h.a.func,transition:h.a.oneOf(["none","fade"]),open:h.a.bool},A.defaultProps={variant:"info",margin:"x-small 0",timeout:0,transition:"fade",open:true,screenReaderOnly:false,liveRegionPoliteness:"assertive",isLiveRegionAtomic:false,onDismiss:void 0,liveRegion:void 0,renderCloseButtonLabel:void 0,closeButtonLabel:void 0,children:null},z))||T)||T)},eCn1:function(e,n,r){"use strict"
var t=r("An8g")
var o=r("Ff2n")
var a=r("pQTu")
var i=r("m0r6")
...
y.defaultProps={padding:"small",contentPadding:"0",errorImageUrl:f.a}
function y(e){let n=e.padding,r=e.headerPadding,a=e.contentPadding,i=e.errorSubject,s=e.errorCategory,b=e.errorImageUrl,f=e.label,y=e.title,k=e.onDismiss,_=e.children,O=Object(o["a"])(e,["padding","headerPadding","contentPadding","errorSubject","errorCategory","errorImageUrl","label","title","onDismiss","children"])
null==r&&(r="0 0 ".concat(n," 0"))
null==y&&(y=f)
var B=Object(t["a"])(v["a"].Item,{grow:true},void 0,Object(t["a"])(h["a"],{ellipsis:true},void 0,y))
function j(){return Object(t["a"])(v["a"],{as:"div",padding:r},void 0,B,Object(t["a"])(v["a"].Item,{},void 0,Object(t["a"])(l["a"],{onClick:k,size:"small"},void 0,c.t("Close"))))}var C=Object(t["a"])(g["a"],{imageUrl:b,errorSubject:i,errorCategory:s})
var I=Object(t["a"])(u["a"],{as:"div",padding:a,width:"100%",height:"100%"},void 0,_)
function S(){return Object(t["a"])(m["a"],{errorComponent:C},void 0,I)}return d.a.createElement(p["a"],Object.assign({label:f,onDismiss:k},O),Object(t["a"])(u["a"],{as:"div",padding:n,position:"absolute",insetBlockStart:"0",insetBlockEnd:"0",insetInlineStart:"0",insetInlineEnd:"0"},void 0,Object(t["a"])("div",{style:{display:"flex",flexDirection:"column",width:"100%",height:"100%"}},void 0,j(),Object(t["a"])("div",{style:{position:"relative",flex:1}},void 0,S()))))}},"p9+C":function(e,n,r){"use strict"
r.d(n,"a",(function(){return a}))
var t=r("q1tI")
var o=r.n(t)
r("17x9")
class a extends o.a.Component{constructor(){super(...arguments)
this.state={hasError:false,error:null}}static getDerivedStateFromError(e){return{hasError:true,error:e}}render(){if(this.state.hasError)return o.a.cloneElement(this.props.errorComponent,{errorSubject:this.state.error.message})
return this.props.children}}},znKQ:function(e,n,r){"use strict"
r.d(n,"a",(function(){return h}))
var t=r("VTBJ")
var o=r("1OyB")
var a=r("vuIU")
...
h.variant="Solid"
h.propTypes=Object(t["a"])({},u["a"].propTypes)}}])

//# sourceMappingURL=30-c-a25bc446a6.js.map